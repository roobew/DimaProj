...
/*var app_facebook = {
    ...
    onDeviceReady: function() {
        app_facebook.receivedEvent('deviceready');
    },
...
function next(){
    console.log("dentro next function");
                        ...
                        error: function(data) {
                            ...
                            googleapi.getToken({
                                ...
                                return googleapi.userInfo({ access_token: data.access_token });
                                    ...
                                    console.log("QUIII2222!");
                                    //Show the greet view if we get a valid token

                                    document.location.href="home_google.html";   
                                
                                }).fail(function() {
                                    console.log("GOOGLE: no token");
